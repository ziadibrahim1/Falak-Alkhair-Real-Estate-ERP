...
| عمولات المسوّقين (Commissions) — توليد تلقائي عند تفعيل العقد | ✅ | — (تُعرض ضمن الموديول المالي لاحقًا) |
| المستندات (Document) | ✅ كيان + جدول جاهز | — (رفع الملفات لاحقًا) |
| المرجّعات المركزية (Number Generator) | ✅ (متزامن مع بيانات البذر) | — |

بقية الموديولات (Listings, Sales, Maintenance, Marketing, Auctions ...) موثّقة كخطة تنفيذ في [ROADMAP.md](./ROADMAP.md) ولم تُبنَ بعد.
