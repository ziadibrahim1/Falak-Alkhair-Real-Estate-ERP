...
namespace FalakAlkhair.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260903204912_AddNotificationsModule")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FalakAlkhair.Domain.Entities.Auction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("WinnerBuyerId");

                    b.HasIndex("CompanyId", "AuctionNumber")
                        .IsUnique();

                    b.ToTable("Auctions");
                });

            modelBuilder.Entity("FalakAlkhair.Domain.Entities.AuctionAuditLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("FalakAlkhair.Domain.Entities.MaintenanceEmployee", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("FalakAlkhair.Domain.Entities.MaintenanceQuotation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("MaintenanceQuotations");
                });

            modelBuilder.Entity("FalakAlkhair.Domain.Entities.MaintenanceQuotationItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("MaintenanceQuotationItems");
                });

            modelBuilder.Entity("FalakAlkhair.Domain.Entities.MaintenanceRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("FalakAlkhair.Domain.Entities.Notification", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("FalakAlkhair.Domain.Entities.Vendor", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("FalakAlkhair.Domain.Entities.Auction", b =>
                {
                    ...
                    b.HasOne("FalakAlkhair.Domain.Entities.Buyer", "WinnerBuyer")
                        .WithMany()
                        .HasForeignKey("WinnerBuyerId")
                        .OnDelete(DeleteBehavior.Restrict);
                    ...
                    b.Navigation("WinnerBuyer");
                });

            modelBuilder.Entity("FalakAlkhair.Domain.Entities.AuctionAuditLog", b =>
                {
                    b.HasOne("FalakAlkhair.Domain.Entities.Auction", "Auction")
                        .WithMany("AuditLogs")
            ...
            modelBuilder.Entity("FalakAlkhair.Domain.Entities.MaintenanceQuotation", b =>
                {
                    b.HasOne("FalakAlkhair.Domain.Entities.MaintenanceRequest", "MaintenanceRequest")
                        .WithMany("Quotations")
                        .HasForeignKey("MaintenanceRequestId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("FalakAlkhair.Domain.Entities.Vendor", "Vendor")
                        .WithMany("Quotations")
            ...
            modelBuilder.Entity("FalakAlkhair.Domain.Entities.MaintenanceQuotationItem", b =>
                {
                    b.HasOne("FalakAlkhair.Domain.Entities.MaintenanceQuotation", "Quotation")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("FalakAlkhair.Domain.Entities.MaintenanceRequest", b =>
                {
                    b.HasOne("FalakAlkhair.Domain.Entities.MaintenanceEmployee", "AssignedEmployee")
                        .WithMany("AssignedRequests")
                        .HasForeignKey("AssignedEmployeeId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("FalakAlkhair.Domain.Entities.Vendor", "AssignedVendor")
                        .WithMany("AssignedRequests")
